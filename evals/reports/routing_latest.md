...
Queries: 40 · Production (deterministic): **92.50%** (macro F1 92.63%) · Keyword-first+LLM: 82.50% · LLM-only few-shot: 67.50% (zero-shot measured at 20.00%) · Method mix: {'keyword_default': 9, 'keyword': 31}

| Route | Production F1 | Keyword+LLM F1 | LLM-only F1 | Keyword-only F1 |
| --- | --- | --- | --- | --- |
| factual_rag | 82.35% | 54.55% | 42.86% | 82.35% |
| structured_lookup | 94.12% | 69.57% | 66.67% | 94.12% |
