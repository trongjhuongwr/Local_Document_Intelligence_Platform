...
const enTranslations: Translations = {
  common: {
    ...
    loadFailed: 'Could not load data from the API',
    notGenerated: 'Not yet generated — run the benchmark',
    endpointMissing: 'This endpoint is not available on the backend yet.',
    total: 'Total',
    items: 'items',
    documents: 'Documents',
    findings: 'Findings',
  ...
  nav: {
    ...
    engineDiagnosticsDesc: 'Live model, database and retrieval health',
  ...
  home: {
    ...
    welcomeSubtitle: 'Multi-document verification, deterministic reconciliation, and a searchable audit trail.',
    heroBadge: 'Local-first document audit engine',
  ...
  ask: {
    ...
    copilotDesc: 'Multi-document Q&A answered from retrieved passages, with every citation resolved back to its source chunk.',
    ...
    disclaimer: 'Answers come from a local model; check them against the cited passages.',
  },
  audit: {
    title: 'Audit Trail',
    subtitle:
      'Events projected from the case, document, workflow, review and query tables, with a SHA-256 integrity digest computed over the event sequence.',
    recordSignOff: 'Record Sign-Off',
    cryptoIntegrity: 'Integrity Digest',
    chainValid: 'Digest recomputed and verified',
    chainInvalid: 'Digest mismatch — event sequence changed',
    totalEvents: 'Total Events',
    complianceStandard: 'Digest Algorithm',
    action: 'Action',
    actor: 'Actor',
  ...
  auditTrail: {
    title: 'Audit Trail',
    subtitle:
      'Event history with a SHA-256 integrity digest recomputed over the sequence on every read.',
    cryptoVerifiedBadge: 'Integrity digest verified',
    chainIntegrityDesc: 'The digest was recomputed over the current event sequence and matched.',
  ...
  evaluation: {
    ...
    subtitle: 'Measured retrieval, extraction, routing, discrepancy and workflow results from the last benchmark run.',
...
const viTranslations: Translations = {
  common: {
    ...
    loading: 'Đang xử lý...',
    retry: 'Thử lại',
    apiUnavailable: 'Không kết nối được API máy chủ',
    loadFailed: 'Không tải được dữ liệu từ API',
    notGenerated: 'Chưa có dữ liệu — hãy chạy bộ đo kiểm',
    endpointMissing: 'Máy chủ chưa cung cấp điểm cuối (endpoint) này.',
    total: 'Tổng cộng',
    items: 'mục',
  ...
  nav: {
    ...
    engineDiagnosticsDesc: 'Tình trạng mô hình, cơ sở dữ liệu và truy hồi',
  ...
  home: {
    ...
    welcomeSubtitle: 'Đối soát chéo đa tài liệu, kiểm tra xác định và nhật ký kiểm toán có thể tra cứu.',
    heroBadge: 'Động cơ đối soát tài liệu chạy cục bộ',
  ...
  ask: {
    ...
    subtitle: 'Đặt câu hỏi bằng ngôn ngữ tự nhiên; câu trả lời được tổng hợp từ các đoạn văn bản truy hồi được.',
    copilotTitle: 'Trợ lý AI Truy vấn Chứng từ Gốc',
    copilotDesc: 'Hỏi đáp đa tài liệu, mỗi trích dẫn đều được đối chiếu lại với đoạn văn bản nguồn.',
    ...
    disclaimer: 'Câu trả lời do mô hình cục bộ sinh ra; hãy đối chiếu với các đoạn trích dẫn.',
  },
  audit: {
    title: 'Nhật ký Kiểm toán',
    subtitle:
      'Sự kiện được tổng hợp từ các bảng hồ sơ, tài liệu, quy trình, thẩm định và truy vấn, kèm giá trị băm toàn vẹn SHA-256 tính trên chuỗi sự kiện.',
    recordSignOff: 'Ký Duyệt Biên bản',
    cryptoIntegrity: 'Giá trị băm toàn vẹn',
    chainValid: 'Đã tính lại và khớp giá trị băm',
    chainInvalid: 'Giá trị băm không khớp — chuỗi sự kiện đã thay đổi',
    totalEvents: 'Tổng số Sự kiện',
    complianceStandard: 'Thuật toán băm',
    action: 'Hành động',
    actor: 'Chủ thể',
  ...
  auditTrail: {
    title: 'Nhật ký Kiểm toán',
    subtitle:
      'Lịch sử sự kiện kèm giá trị băm toàn vẹn SHA-256, được tính lại trên chuỗi sự kiện ở mỗi lần đọc.',
    cryptoVerifiedBadge: 'Đã xác minh giá trị băm toàn vẹn',
    chainIntegrityDesc: 'Giá trị băm được tính lại trên chuỗi sự kiện hiện tại và khớp.',
  ...
  evaluation: {
    ...
    subtitle: 'Kết quả đo được về truy hồi, bóc tách, phân luồng, sai lệch và quy trình từ lần chạy đo kiểm gần nhất.',
